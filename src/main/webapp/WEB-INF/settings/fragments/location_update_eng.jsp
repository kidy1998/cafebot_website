                    ...
                    <div class="dasom-location-radio">
                        ...
                        <label class="custom-label first-label" for="entrance">
                            <input type="radio" name="location"
                                   id="entrance" value="Near Entrance" ${theLocation.location eq 'Near Entrance' ? 'checked' : ''}>
                            Near Entrance
                        </label>
                        <label class="custom-label" for="counter">
                            <input type="radio" name="location"
                                   id="counter" value="Near Counter" ${theLocation.location eq 'Near Counter' ? 'checked' : ''}>
                            Near Counter
                        </label>
                        <label class="custom-label" for="pickupTable">
                            <input type="radio" name="location"
                                   id="pickupTable" value="Near PickupTable" ${theLocation.location eq 'Near PickupTable' ? 'checked' : ''}>
                            Near Pickup Table
                        </label>
                        <label class="custom-label" for="goodsDisplay">
                            <input type="radio" name="location"
                                   id="goodsDisplay" value="Near the goods stand" ${theLocation.location eq 'Near the goods stand' ? 'checked' : ''}>
                            Near Goods Display
                        </label>
                        <label class="custom-label" for="other">
                            <input type="radio" name="location"
                                   id="other" value="Other" ${theLocation.location eq 'Other' ? 'checked' : ''}>
                            Other
                        </label>
                    </div>
